...
const StaffDashboard = () => {
  ...
  const fetchAssignedComplaints = async () => {
    ...
    setError(null);
    try {
      const res = await axios.get(`${API_BASE_URL}/api/complaints/assigned`, authHeaders);
  ...
  const fetchProfile = async () => {
    try {
      const res = await axios.get(`${API_BASE_URL}/api/auth/profile`, authHeaders);
  ...
  const submitStaffUpdate = async (selectedComplaint, formData) => {
    try {
      await axios.post(
        `${API_BASE_URL}/api/complaints/${selectedComplaint._id}/staff-update`,
        formData,
        {
          headers: {
      ...
      console.error('Submit staff update error:', err);
    }
  };
      ...
      <div className="row mb-4">
        ...
        <div className="col-md-4 text-md-end">
          <div className="d-flex gap-2 justify-content-md-end">
            ...
            <button className="btn btn-outline-primary btn-sm" onClick={fetchAssignedComplaints}>
        ...
        <div className="card mb-4">
          <div className="card-body">
            ...
            <div className="progress mb-2" style={{ height: '25px' }}>
              <div className="progress-bar bg-success" style={{ width: `${(stats.resolved / stats.total) * 100}%` }}>
                {stats.resolved} Resolved
              </div>
              <div className="progress-bar bg-warning" style={{ width: `${(stats.inProgress / stats.total) * 100}%` }}>
                {stats.inProgress} In Progress
              </div>
              <div className="progress-bar bg-secondary" style={{ width: `${(stats.pending / stats.total) * 100}%` }}>
            ...
            <div className="col-md-6 col-lg-4 mb-4" key={c._id}>
              <div className="card shadow-sm h-100">
                ...
                <div className="card-footer bg-transparent">
                  <button className="btn btn-primary btn-sm w-100" onClick={() => handleSelect(c)}>
                  ...
                  <div className="row">
                      ...
                      <div className="mb-3">
                        ...
                        <div className="border rounded p-3 bg-light">
                          ...
                          <p>
                            ...
                            <span className={`badge bg-${statusColors[selectedComplaint.status] || 'secondary'} ms-2`}>
                    ...
                    <div className="col-md-6">
                      ...
                      <div className="mb-3">
                        ...
                        />
                        <small className="text-muted">
                          Upload a photo showing the work progress or completion
                        </small>
                      </div>
